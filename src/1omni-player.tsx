...
import { Play, Pause, SkipBack, SkipForward, Volume2, Heart, Share2, User, Music, Headphones, Radio } from 'lucide-react';
...
const OmniPlayer = () => {
  ...
  // Simulação da animação de ondas
  useEffect(() => {
  ...
  // Função para gerar valores de onda para visualização
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-full h-32 flex items-center justify-center space-x-1">
            {waveValues.map((wave, i) => {
              ...
              const adjustedIndex = (i + animationOffset) % waveValues.length;
              const wavePoint = waveValues[adjustedIndex];
              
              // Alternar cores para efeito visual
              let color;
